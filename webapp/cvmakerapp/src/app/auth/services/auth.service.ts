...
export class AuthService {
  private apiUrl = 'https://cvmaker-uzip.onrender.com/api/users';
  ...
  uploadCv(file: File, userId: number): Observable<any> {
    ...
    return this.http.post(
      'https://cvmaker-uzip.onrender.com/api/cvfile/uploadPdf',
      formData,
      {
        headers,
      }
  ...
  getUserCvs(userId: string): Observable<any> {
    return this.http.get<CvFile[]>(
      `https://cvmaker-uzip.onrender.com/api/cvfile/list/${userId}`,
      { headers: this.getAuthHeaders() }
    );
  }
  ...
  deleteCv(cvId: string): Observable<any> {
    return this.http.delete(
      `https://cvmaker-uzip.onrender.com/api/cvfile/delete/${cvId}`,
      {
        headers: this.getAuthHeaders(),
        responseType: 'text',
      }
